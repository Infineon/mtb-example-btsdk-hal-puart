...
This application demonstrates how to use PUART APIs to read data from a terminal as well as display data on a terminal. It uses the Cypress Bluetooth SoCs and ModusToolbox™ Integrated Development Environment (IDE).
