...
The RTS/CTS hardware flow control is also demonstrated for the CYW920706WCDEVAL platform. Build with PUART_RTS_CTS_FLOW=1 on the command line to enable this mode. Refer to the source code and hardware schematics regarding pin setup and board switch configuration.

## Requirements

- **Tool:** [ModusToolbox&#8482;](https://www.cypress.com/products/modustoolbox-software-environment) v2.0
...
Refer to `README` in repo root folder for instruction on how to build and program the code example using the ModusToolBox&#8482; IDE and CLI.
